...
fp2_write_to_file(X, n, "xDBLe_mem_X_0.txt", "xDBLe_mem_X_1.txt")
fp2_write_to_file(ZZ, n, "xDBLe_mem_Z_0.txt", "xDBLe_mem_Z_1.txt")
fp2_write_to_file(A24, n, "xDBLe_mem_A24_0.txt", "xDBLe_mem_A24_1.txt")
fp2_write_to_file(C24, n, "xDBLe_mem_C24_0.txt", "xDBLe_mem_C24_1.txt")
...
(t6, t7) = xDBLe_hw(X, ZZ, A24, C24,loop)

fp2_write_to_file(t6, n, "sage_xDBLe_t6_0.txt", "sage_xDBLe_t6_1.txt")
fp2_write_to_file(t7, n, "sage_xDBLe_t7_0.txt", "sage_xDBLe_t7_1.txt") 
