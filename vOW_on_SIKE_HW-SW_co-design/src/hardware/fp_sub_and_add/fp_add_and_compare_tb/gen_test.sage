...
if (c > 2*p):
  print "\nSage comparison result: a is bigger than b"
  f_d.write("(a+b) is bigger than 2p.")
  f_d.write("\n")
else:
  print "\nSage comparison result: a is NOT bigger than b."
  f_d.write("(a+b) is NOT bigger than 2p.")
  f_d.write("\n")
