...
(t2, t3) = xDBL(X, ZZ, A24, C24)

fp2_write_to_file(t2, n, "sage_t2_0.txt", "sage_t2_1.txt")
fp2_write_to_file(t3, n, "sage_t3_0.txt", "sage_t3_1.txt") 

(t2, t3) = xDBL(X, ZZ, A24, C24)

#fp2_write_to_file(t0, n, "sage_t0_0.txt", "sage_t0_1.txt")
#fp2_write_to_file(t1, n, "sage_t1_0.txt", "sage_t1_1.txt") 
fp2_write_to_file(t2, n, "sage_t2_0.txt", "sage_t2_1.txt") 
fp2_write_to_file(t3, n, "sage_t3_0.txt", "sage_t3_1.txt")
#fp2_write_to_file(t4, n, "sage_t4_0.txt", "sage_t4_1.txt")
#fp2_write_to_file(t5, n, "sage_t5_0.txt", "sage_t5_1.txt") 
