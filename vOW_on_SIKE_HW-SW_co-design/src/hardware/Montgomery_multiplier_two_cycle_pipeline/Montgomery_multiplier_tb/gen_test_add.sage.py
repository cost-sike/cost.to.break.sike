...
# This file was *autogenerated* from the file ../../Montgomery_multiplier_two_cycle_pipeline/Montgomery_multiplier_tb/gen_test_add.sage
...
for k in range(_sage_const_1 ):
    ...
    for i in range(n): 
        ...
        for j in range(_sage_const_1 , n): 
            ...
            f_res_all.write(str(j-_sage_const_1 ) + "  ")
            f_res_all.write(hex_format_element.format(t[j-_sage_const_1 ]))
            f_res_all.write("\n") 
            f_carry.write(bindigits(C, w+_sage_const_2 ))
            f_carry.write("\n")
        t[n-_sage_const_1 ] = C  
        f_res_all.write(str(i) + "  ")
        f_res_all.write(str(n-_sage_const_1 ) + "  ")
        f_res_all.write(hex_format_element.format(t[n-_sage_const_1 ]))
        f_res_all.write("\n\n")
