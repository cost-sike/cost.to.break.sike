// software test for get_4_isog and eval_4_isog function
...
void main() {
  ...
  // digit_t *COEFF_0_0 = (digit_t*)&((coeff[0])[0]);
  // digit_t *COEFF_0_1 = (digit_t*)&((coeff[0])[1]);
  // digit_t *COEFF_1_0 = (digit_t*)&((coeff[1])[0]);
  // digit_t *COEFF_1_1 = (digit_t*)&((coeff[1])[1]);
  // digit_t *COEFF_2_0 = (digit_t*)&((coeff[2])[0]);
  // digit_t *COEFF_2_1 = (digit_t*)&((coeff[2])[1]);
