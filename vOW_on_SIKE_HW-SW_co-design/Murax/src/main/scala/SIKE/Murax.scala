...
case class Murax(config : MuraxConfig) extends Component{
  ...
  val system = new ClockingArea(systemClockDomain) {
    ...
    // customized part
    // if (config.Apb3MontgomeryMultiplier) {
    //    val Montgomery_multiplier = new Apb3MontgomeryMultiplier()
    ...
    // if (config.Apb3Reduce) {
    //    val mul_and_reduce_pipe = new Apb3Reduce()
    //    apbSlaves += mul_and_reduce_pipe.io.apb -> (0x30000, 4 kB)
    // }

    // if (config.Apb3SparseMul) {
    //    val sparse_mul = new Apb3SparseMul()
    //    apbSlaves += sparse_mul.io.apb -> (0x40000, 4 kB)
    // }

    // if (config.Apb3PolyMul) {
    //    val poly_mul_pipe = new Apb3PolyMul()
    //    apbSlaves += poly_mul_pipe.io.apb -> (0x50000, 4 kB)
    // }

    // if (config.Apb3SHAKE) {
    //    val keccak_top = new Apb3SHAKE()
    //    apbSlaves += keccak_top.io.apb -> (0x60000, 4 kB)
    // }

    // if (config.Apb3GaussSampler) {
    //    val gauss = new Apb3GaussSampler()
    //    apbSlaves += gauss.io.apb -> (0x70000, 4 kB)
    // } 

    // if (config.Apb3Kmax) {
    //    val Kmax_and_sum = new Apb3Kmax()
    //    apbSlaves += Kmax_and_sum.io.apb -> (0x80000, 4 kB)
    // } 
...
//           Murax(MuraxConfig.default.copy(Apb3MontgomeryMultiplier=true))
