...
// Fixed parameters for isogeny tree computation in vOW algorithm
#define LENSTRAT                6
...
// 128-bit multiprecision subtraction, c = a-b+2p or c = a-b+4p
extern void mp_sub128_p2(const digit_t* a, const digit_t* b, digit_t* c);
extern void mp_sub128_p4(const digit_t* a, const digit_t* b, digit_t* c);
void mp_sub128_p2_asm(const digit_t* a, const digit_t* b, digit_t* c); 
void mp_sub128_p4_asm(const digit_t* a, const digit_t* b, digit_t* c); 
