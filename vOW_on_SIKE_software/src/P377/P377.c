/********************************************************************************************
* NEW supersingular isogeny parameters and generation of functions for P377
*********************************************************************************************/ 
...
#define fpinv_mont_ct                 fpinv377_mont_ct
#define fpinv_chain_mont              fpinv377_chain_mont
#define fpinv_mont_bingcd             fpinv377_mont_bingcd
